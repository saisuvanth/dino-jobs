...
const { login, signup, verifyEmail, updateUser } = require('../controllers/userController');
...
router.post('/update-user', getLogin, async (req, res, next) => {
	const data = req.body;
	console.log(req.user)
	const result = await updateUser(req.user, data);
})
